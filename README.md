...
- __NI DataPlugins: Export DataPlugin__: Use this option if want to publish your DataPlugin and make it available to other users. Your code will be embedded in the *.uri file.
